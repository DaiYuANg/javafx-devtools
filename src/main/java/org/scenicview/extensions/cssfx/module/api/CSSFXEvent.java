...
public final class CSSFXEvent<T> {
  ...
  public static enum EventType {
    STYLESHEET_ADDED, STYLESHEET_REMOVED, NODE_ADDED, NODE_REMOVED, SCENE_ADDED, SCENE_REMOVED, STAGE_ADDED, STAGE_REMOVED, STYLESHEET_REPLACED, STYLESHEET_MONITORED
  }
